...
SAVE_DIRECTORY = "cards/" #The folder where the images get saved
EXPANSIONS = {"341": {"name": "Call of the Archons", "count": 370}, "435": {"name": "Age of Ascension", "count": 370}}
LANGUAGES = [{"code": "fr-fr", "folder": "fr/"}] #Languages you want to download, choose from the following list:
